...
from .asts import recurse_through_ast
from .contextmanagers import suppress
...
def _tree_image(tree, settings, save_path, format):
...
def render(node, settings, save_path, format):
    """
    ...
    #     return fname
    return _tree_image(tree, settings, save_path, format)